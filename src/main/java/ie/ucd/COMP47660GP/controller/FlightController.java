...
public class FlightController {
    ...
    public String getFlights(@RequestParam("source") String origin, @RequestParam(value = "destination") String dest,
            @RequestParam(value = "dateTime") String dateStr, Model model) {
    ...
    public void addNewFlight(@ModelAttribute("flight") Flight flight, BindingResult bindingResult, Model model) {
    ...
    public String updateFlight(@ModelAttribute("flight") Flight flight, BindingResult bindingResult, Model model) {
        ...
        LocalTime time = LocalTime.parse(flight.getTime());
        LocalDateTime localDateTime = LocalDateTime.of(date, time);
        flightRepository.updateFlightInfo(flight.getSource(), flight.getDestination(), localDateTime, flight.getDate(),
                flight.getTime(), flight.getFlightNum());
        return "admin";
    }
