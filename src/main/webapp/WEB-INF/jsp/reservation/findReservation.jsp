...
<div style="text-align: center;">
    ...
    <form:form method="get" modelAttribute="reservation" action="/admin/reservation">
    ...
    <table style="margin-left: auto; margin-right: auto; border: 1px solid black">
        ...
        <tr>
            ...
            <td style="border: 1px solid black;"><a href="${contextPath}/editReservation/${reservation.reservation_id}">Edit Reservation</a></td>
        </tr>
        </tbody>
    </table>
