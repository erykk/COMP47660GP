...
<div style="text-align: center;">
    ...
    <form:form method="get" modelAttribute="reservation" action="/admin/deleteReservation">
    <table style="margin-left: auto; margin-right: auto">
        <tr>
            <td>Enter reservations ID:</td>
            <td>
    ...
    <form:form method="get" action="/editReservation">
    <c:choose>
    ...
    <table style="margin-left: auto; margin-right: auto; border: 1px solid black">
        ...
        <tr>
            ...
            <td style="border: 1px solid black;"><a href="${contextPath}/deleteReservation/${reservation.reservation_id}">Delete Reservation</a></td>
        </tr>
        </tbody>
    </table>
